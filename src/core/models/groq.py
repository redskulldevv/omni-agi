...
class GroqAI:
    ...
    async def analyze_market_fast(self, context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def quick_sentiment(self, text: str) -> Dict[str, Union[float, str]]:
        ...
        try:
            ...
            response = await self.generate_response(
                prompt=prompt, temperature=0.1, max_tokens=100
            )
