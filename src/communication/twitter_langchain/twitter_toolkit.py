    ...
    *Security Note*: This toolkit contains tools that can read and modify
    ...
    Use within an agent:
        .. code-block:: python
            ...
            example_query is "Post a hello tweet to the world"
        ...
        .. code-block:: none
            ...
            Successfully posted!
            ================================== Ai Message ==================================
            The message "hello, world! c4b8e3744c2e4345be9e0622b4c0a8aa" has been
    ...
    @classmethod
    def from_twitter_api_wrapper(
        cls, twitter_api_wrapper: TwitterApiWrapper
    ) -> "TwitterToolkit":
